...
simxInt* res_middle = new simxInt[2](), * leftJoint = new simxInt[1](), * rightJoint = new simxInt[1](),  * lineSensor = new simxInt[1](), * eBot = new simxInt[1](), * proxSensor = new simxInt[1]();
